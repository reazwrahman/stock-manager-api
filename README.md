...
The **Stock Manager API** is a Java-based application designed to manage and process stock data efficiently. Built using
**Spring Boot**, it provides a robust backend for handling stock-related operations such as retrieving stock prices,
caching results, and sorting stocks based on various criteria.
...
- **Concurrent Batch Processing**: Splits stock data into manageable batches for efficient processing using
  multithreading.
